...
client that consumes a Spring MVC-based RESTful web service.
...
This will create a `bower.json` file that describes each JavaScript package
...
Next, use Bower to install rest.js and an AMD module
...
This AMD module uses simple DOM
